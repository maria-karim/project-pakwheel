...
export default function CarDisplay() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      <h1 className="text-3xl font-bold text-gray-800 mb-4">Toyota Corolla 2024 Model</h1>
      
      <div className="w-72 h-77 relative mb-1">
        <Image 
          src="/toyota corolla.png" 
          alt="Toyota Corolla 2024 Model"
          width={300}
          height={300}
    ...
    <p className="text-3xl font-medium text-green-400 mt-4">PKR 50,00000</p>
    <Link href="/form">
